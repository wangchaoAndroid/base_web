...
package core.com.eryansky.common.utils;
...
import core.com.eryansky.common.utils.collections.MapUtils;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils{
     ...
     * @see
     *      <ul>
     *      <li>见{@link p(String, String, String, String)}</li>
     *      </ul>
     */
    ...
    public static boolean eqStr(String str1,String str2){
        ...
        {
        	l1.add(toInteger(s1[i]));
        	l2.add(toInteger(s2[i]));
        }
        Collections.sort(l1);
        Collections.sort(l2);
    ...
    public static void main(String[] args) {
		System.out.println(eqStr("1,2,3,23","3,2,1,23"));
	}
}