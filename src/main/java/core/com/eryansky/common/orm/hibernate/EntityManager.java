...
import core.com.eryansky.common.orm.entity.StatusState;
...
//            filters.add(normal);
//        }
//        return getEntityDao().findPageJoin(p, filters);
//    }
//
//
//	/**
...
//	 */
//	@Transactional(readOnly = true)
//	public List<T> findJoin(final List<PropertyFilter> filters)
//			throws DaoException, SystemException, ServiceException {
//		return getEntityDao().findJoin(filters);
//	}
}